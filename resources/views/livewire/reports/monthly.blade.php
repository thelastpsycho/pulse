    ...
    <div class="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6">
            <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
                <div>
                    ...
                    <p class="text-sm text-muted ml-13">Detailed breakdown of issues for a specific month</p>
                </div>
                <a href="{{ route('reports.index') }}" class="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-surface-2/50 hover:bg-surface-2 border border-border/50 hover:border-accent/30 transition-all group">
        ...
        <div class="glass-card rounded-xl p-4 mb-6">
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                ...
                <!-- Month -->
                <div>
                    <label class="block text-sm font-medium text-text mb-1.5">Month</label>
